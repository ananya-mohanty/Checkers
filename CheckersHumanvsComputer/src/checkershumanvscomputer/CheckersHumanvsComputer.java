...
// */
package checkershumanvscomputer;
...
//        if()
   ...
   int nextMove(int i1, int j1, int i2, int j2){
       if(matrix[i1][j1]!='R' && matrix[i2][j2]!='r'){
           return -1;
       }

           if(Math.abs(i1-i2)==2){
               if(i2==i1-2 && j2==j1+2 && (matrix[i1-1][j1+1]=='B'||matrix[i1-1][j1+1]=='b') && matrix[i2][j2]=='-'){
                   matrix[i1-1][j1+1]='-';
               ...
               if(matrix[i1][j1]=='r' && i2==i1-2 && j2==j1-2 && (matrix[i1-1][j1-1]=='B'||matrix[i1-1][j1-1]=='b') && matrix[i2][j2]=='-'){
                   matrix[i1-1][j1-1]='-';
...
public class CheckersHumanvsComputer {
...
//            Thread.sleep(5000);
//            System.out.println(b.x/50 +" "+b.y/50);System.out.println(b.x +" "+b.y);System.out.println(b.x +" "+b.y);System.out.println(b.x +" "+b.y);System.out.println(b.x +" "+b.y);
//        while(m==0){
//          
//                    Thread.sleep(5000);
//                    int xa=b.x, ya=b.y;
//                    xOriginal=xa;
//                    yOriginal=ya;
////                    System.out.print("khatam");
//                    
////                    System.out.println(xa +" "+ya);
//                    if(xOriginal>=0 && xOriginal<=7 && yOriginal>=0 &&yOriginal>=7&& xOriginal==b.x && yOriginal ==b.y)
//                    {
//                        k++;
//                        System.out.println(b.x +" "+b.y);
//                    }
...
//                     System.out.println(xa/25+" "+ya/25 +" "+xb/25+" "+ yb/25);
////                   break;
                while(t==0 || t2==0){
                    Thread.sleep(5000);
                   System.out.println("Enter which peg");
                   Thread.sleep(1000);
...
//                   String k=sc.nextLine();
                   ...
                   Thread.sleep(5000);
                   System.out.println("Enter where peg");
                    Thread.sleep(1000);
//                  Thread.sleep(5000);
//                    System.out.println(b.x/50 +" "+b.y/50);
                   int x2=b.x/50;
